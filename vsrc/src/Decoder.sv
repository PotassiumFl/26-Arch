...
module decoder import common::*;(
    ...
    always_comb begin : imm_generator
        case (decoder_ctrl.instr[6:0]) inside
            ...
            7'b0110111:imm = {{33{decoder_ctrl.instr[31]}},decoder_ctrl.instr[30:12],12'b0};
    ...
    always_comb begin : offset_generator
        case (decoder_ctrl.instr[6:0])
            7'b1100011:offset = {{52{decoder_ctrl.instr[31]}},decoder_ctrl.instr[7],decoder_ctrl.instr[30:25],decoder_ctrl.instr[11:8],1'b0};
            7'b1100111:offset = {{53{decoder_ctrl.instr[31]}},decoder_ctrl.instr[30:20]};
            7'b1101111:offset = {{44{decoder_ctrl.instr[31]}},decoder_ctrl.instr[19:12],decoder_ctrl.instr[20],decoder_ctrl.instr[30:21],1'b0};
        ...
        case (decoder_ctrl.instr[6:0]) inside
            7'b0?1?011: begin 
                case (decoder_ctrl.instr[14:12])
                    ...
                    3'b111:ALU_ctrl.opr=decoder_ctrl.instr[25]?REMU:AND;
                endcase
                end
            7'b1100011:begin
                case (decoder_ctrl.instr[14:12])
                    ...
                    3'b101:ALU_ctrl.cond_index = GREATER;
                    3'b110:ALU_ctrl.cond_index = LESSU;
